...
public class QuoteServiceImplTest {
	...
	public void testCalculSommePourcentageGlobal() {
		//assertThat(quoteServiceImpl.calculSommePourcentageGlobal(phases)).isEqualTo(0);
		phase1.setValue(23);
		phases.add(phase1);
		assertThat(quoteServiceImpl.calculSommePourcentageGlobal(phases)).isEqualTo(23);
	}
